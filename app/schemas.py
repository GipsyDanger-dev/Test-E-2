...
Category = Literal['sales_opportunity','existing_customer_support','billing_query','technical_enquiry','partner_coordination','job_application','internal_system_alert','contact_detail_correction','legal_compliance','junk','unknown']
Action = Literal['qualify_opportunity','request_information','review_billing_discrepancy','technical_triage','coordinate_schedule','review_application','investigate_internal_incident','update_contact_details','review_legal_compliance','archive_junk','human_review']
