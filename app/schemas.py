...
class ExtractedFacts(BaseModel):
    ...
    invoice_number: str | None = None; purchase_order: str | None = None; invoice_value: float | None = None; po_value: float | None = None; discrepancy_value: float | None = None; requested_timeline: str | None = None; corrected_phone: str | None = None; preferred_email: str | None = None
